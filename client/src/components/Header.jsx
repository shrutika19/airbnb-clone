    ...
    return (
        <header className='flex justify-between'>
            ...
            <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
                <div className='hidden sm:flex'>Anywhere</div>
                <div className='hidden sm:flex border-l border-gray-300'></div>
                <div className='hidden sm:flex'>Any week</div>
                <div className='hidden sm:flex border-l border-gray-300'></div>
                <div className='hidden sm:flex text-gray-500'>Add guests</div>
